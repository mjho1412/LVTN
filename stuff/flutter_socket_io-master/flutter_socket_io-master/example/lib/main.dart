...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _connectSocket01() {
    ...
    socketIO = SocketIOManager().createSocketIO("http://192.168.1.102:3003", "", query: "userId=21031", socketStatusCallback: _socketStatus);

    //call init socket before doing anything
    socketIO.init();

    //subscribe event
    socketIO.subscribe("abc", _onSocketInfo);
  ...
  void _sendChatMessage(String msg) async {
    if (socketIO != null) {
      ...
      socketIO.sendMessage("login_kid", jsonData, _onReceiveChatMessage);
    }
  }
